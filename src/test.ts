...
let app: App = {
    ...
    init: function() {
        ...
        document.getElementById('destination-form')?.addEventListener('submit', app.handleSubmitForm)
    ...
    handleSubmitForm: function(event) {
        ...
        if (app.destinationslist.includes(app.destinationName)) {
            ...
            const inputElements = document.querySelectorAll('#destination-form input') as NodeListOf<HTMLInputElement>;
            ...
            const arrivalDateElement = document.getElementById('arrival-date') as HTMLInputElement
            const stayDaysElement = document.getElementById('stay-days') as HTMLInputElement
    ...
    updateItinerary: function() {
        ...
        const itineraryList = document.getElementById('itinerary') ?? document.createElement('ul')
    ...
    redrawMapAndItinerary: function() {
        ...
        app.map.eachLayer((layer: L.Layer) => {
    ...
    drawRoute: function() {
        ...
        directionsService.route(directionsRequest, function(response: google.maps.DirectionsResult | null, status: google.maps.DirectionsStatus | null) : void {
            if (status === 'OK') {
