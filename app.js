let app = {
    ...
    handleSubmitForm: function(event) {
        ...
        if (app.destinationslist.includes(app.destinationName)) {
            ...
            inputElement = document.querySelectorAll('#destination-form input')
            ...
            app.arrivalDate.push(document.getElementById('arrival-date').value)
            app.duration.push(document.getElementById('stay-days').value)
    ...
    loadFromLocalStorage: function() {
        const data = JSON.parse(localStorage.getItem('tripPlannerData'));
        if (data) {
            app.lat = data.lat;
            app.lng = data.lng;
